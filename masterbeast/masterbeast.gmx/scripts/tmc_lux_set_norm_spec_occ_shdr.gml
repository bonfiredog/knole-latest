...
shader_set(tmc_lux_norm_spec_occ_shdr);
...
with(tmc_lux_get_anchor(x,y))
{
    ...
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_LightPos,lightpos); //XYZ
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_LightColor,lightcols); //R,G,B, Strength
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_Falloff,lightfalloffs); 
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_MaxRange,ranges); 
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_ConeSpecs,conespecs); 
...
shader_set_uniform_f(global.tmc_lux_sh_norm_spec_occ_pos_Z,z);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_GlobalAmbientColor,global.tmc_lux_GlobalAmbientColor);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_AmbientColor,m_Ambient);

shader_set_uniform_f(global.tmc_lux_sh_norm_spec_occ_Angle,degtorad(image_angle));

texture_set_stage(global.tmc_lux_sh_norm_spec_occ_samp_normaltex, m_NormTex);

shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_source_texture_pos, m_SrcTexPos);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_norm_texture_pos, m_NormTexPos);

texture_set_stage(global.tmc_lux_sh_norm_spec_occ_samp_specular_tex, m_SpecTex);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_spec_texture_pos, m_SpecTexPos);

texture_set_stage(global.tmc_lux_sh_norm_spec_occ_samp_ambiant_tex, m_OccTex);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_amb_texture_pos, m_OccTexPos);

shader_set_uniform_f(global.tmc_lux_sh_norm_spec_occ_LightSmooth,m_LightSmooth);

shader_set_uniform_f_array(global.tmc_lux_sh_norm_spec_occ_flip_rgb, m_FlipRGB);
