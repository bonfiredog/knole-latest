///CreateSigilStainBase(direction,speed,startingscale,friction,shrink,colour,x,y)

//Create an individual stain, setting it going.

if position_meeting(argument6,argument7,mCreatureParent) {
ThisStain = instance_create(argument6 + random_range(-16,16),argument7 + random_range(-16,16),mSigilStain)
