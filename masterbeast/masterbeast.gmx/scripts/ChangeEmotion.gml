...
HappyGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
case "sad":
SadGradual = true
SadGradualDir = argument1
SadGradualRate = argument2 * (1 - ((0.5 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
SadGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
case "anger":
AngerGradual = true
...
AngerGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
case "surprise":
...
SurpriseGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
case "fear":
FearGradual = true
...
FearGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
case "shame":
ShameGradual = true
...
ShameGradualAmount = argument3 * (1 - ((0.3 / 100) * (100 - mCreatureController.Alive)) + (mWorldController.NightEmoMod / 333)) 
break;
}
}
