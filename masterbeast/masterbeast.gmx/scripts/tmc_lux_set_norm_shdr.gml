...
with(tmc_lux_get_anchor(x,y))
{
    ...
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_LightPos,lightpos); //XYZ
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_LightColor,lightcols); //R,G,B, Strength
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_Falloff,lightfalloffs); 
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_MaxRange,ranges); 
    shader_set_uniform_f_array(global.tmc_lux_sh_norm_ConeSpecs,conespecs); 
    

}


shader_set_uniform_f(global.tmc_lux_sh_norm_pos_Z,z);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_GlobalAmbientColor,global.tmc_lux_GlobalAmbientColor);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_AmbientColor,m_Ambient);

shader_set_uniform_f(global.tmc_lux_sh_norm_Angle,degtorad(image_angle));

texture_set_stage(global.tmc_lux_sh_norm_samp_normaltex, m_NormTex);


shader_set_uniform_f_array(global.tmc_lux_sh_norm_source_texture_pos, m_SrcTexPos);
shader_set_uniform_f_array(global.tmc_lux_sh_norm_norm_texture_pos, m_NormTexPos);

shader_set_uniform_f(global.tmc_lux_sh_norm_LightSmooth,m_LightSmooth);

shader_set_uniform_f_array(global.tmc_lux_sh_norm_flip_rgb, m_FlipRGB);
