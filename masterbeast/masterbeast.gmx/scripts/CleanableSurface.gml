...
and mInterfaceController.Cleaning = true
{
//If in contact with correct object and pressing:
if position_meeting(mFinger.x,mFinger.y,argument1)
and mInterfaceController.PressBegun = true 
...
ex_audio_set_volume("clean",BothVolMod(0.6),0)
...
//For Taboos
if position_meeting(mFinger.x,mFinger.y,oTabooLayer1) {
oTabooLayer1.Health -= 0.001
} 
if position_meeting(mFinger.x,mFinger.y,oTabooLayer2) {
oTabooLayer2.Health -= 0.001
} 
if position_meeting(mFinger.x,mFinger.y,oTabooLayer3) {
oTabooLayer3.Health -= 0.001
} 
