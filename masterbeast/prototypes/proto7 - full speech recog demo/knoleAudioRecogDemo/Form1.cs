...
namespace knoleAudioRecogDemo
{
    public partial class Form1 : Form
    {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            GodList.Add(new string[] { "Make me toast", "Make toast", "Call the rain", "Call rain", "Make rain", "Make it rain", "Wink out of existence", "Wink yourself out of existence", "Make me immortal" });
            Grammar GodGrammar = new Grammar(new GrammarBuilder(GodList));
        ...
        private void GodListener_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
           ...
           else if (e.Result.Text == "Wink out of existence" || e.Result.Text == "Wink yourself out of existence")
            {
